...
**Play now:** [Ashvale](https://aronew.github.io/ashvale/)
...
GitHub is the source of truth. The included Actions workflow tests the game and creates a standalone download artifact. GitHub Pages is active at https://aronew.github.io/ashvale/; `ASHVALE_PAGES_ENABLED=true` enables automatic publication after successful checks on pushes to `main`. Pull requests only validate. See [deployment notes](docs/DEPLOYMENT.md).
