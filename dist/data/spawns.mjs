...
export const SPAWNS = {
 ...
 town: {
  props: [
   ...
   ['cart', 47.5, 28.4], ['cart', 26.5, 20.4],
   ['brazier', 33.5, 18.5], ['brazier', 41.5, 18.5], ['brazier', 33.5, 32.5], ['brazier', 41.5, 32.5],
   ['board', 25.5, 27.6, { radius:10, label:'Notice board' }],
   ['loom', 60, 15.5, { radius:12, label:'Lys\u2019s loom' }],
   ['cauldron', 17.5, 40.5, { radius:12, label:'Sera\u2019s stillroom bench' }],
   ['banner', 36, 8.5], ['banner', 38.5, 8.5], ['banner', 70.4, 26.5], ['banner', 70.4, 32.5],
   ['tent', 62.5, 48.5], ['tent', 66.5, 48.5],
   ['sign', 69.5, 32.6, { text:'EAST \u2014 the vale road' }],
   ['sign', 33.6, 8.5, { text:'NORTH \u2014 the ranger road' }]
  ],
  npcs: [
   ['orin', 61.5, 40.5], ['sera', 14.5, 40.5], ['corvin', 36.5, 24.5], ['lys', 57.5, 15.5],
   ['ondt', 30.5, 46.5], ['pim', 42.5, 28.5], ['hesta', 44.5, 21.5], ['aldric', 13.5, 15.5],
   ['vell', 20.5, 12.5], ['rook', 69.5, 29.5], ['gwen', 27.5, 40.5], ['mabe', 49.5, 40.5]
  ],
  nodes: [],
  mobs: []
 },
...
export const LAMPS = {
 town: [[9,26.5],[9,32.5],[23,26.5],[23,32.5],[31,32.5],[45,32.5],[55,32.5],[68,26.5],[68,32.5],
        [36.5,11.5],[38.5,11.5],[22,40.5],[33,40.5],[52,40.5],[26,49.5],[50,49.5],[9,40.5],[68,40.5],[8,17.5],[68,17.5],[24,17.5],[47,17.5],[20,46.5]],
